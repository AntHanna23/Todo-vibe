...
Paragraph 1 motivation: broadly, what is problem area, why is it important?

Paragraph 2 narrow down: what is the problem I am specifically consider

Paragraph 3 elevator pitch : "In the paper, we .": most crucial paragraph

Paragraph 4 contribution: how different/better/relates to other work

Paragraph 5 paper layout: "The remainder of this paper is structured as follows. In Section 2, we introduce  Section 3 describes ... Finding and analysis are provided in Section 4. Finally, the conclusion and future work are described in Section 5." [Note that Section is capitalized. Also, vary your expression between "section" being the subject of the sentence, as in "Section 2 discusses ..." and "In Section, we discuss ...".]
...
In this section related work that is being directly used or being benchmarked should be described here.
...
This section will include any input parameters, benchmark description, performance measures, tables, graphs, comparisons and analysis. 
